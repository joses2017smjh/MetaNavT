...
Intervals: percentile bootstrap over queries, one index matrix shared by all configs (paired deltas); 2000 resamples, seed 0, numpy.random.RandomState.randint. Results file sha 6402412, corpus sha f1ba038674e7.
<!-- bench-table:end -->
...
<!-- bench-neural:start (generated by `make bench-table` from bench/results/main.json; do not edit by hand) -->
Fixture v1 with real models (`make bench-neural`, cuda (Quadro RTX 8000), torch 2.5.1+cu121, sentence-transformers 6.1.0; results sha 29a3bef). Paired deltas vs the same bm25_only row; same bootstrap as above.

| config | models (revision) | nDCG@10 [95% CI] | Recall@10 [95% CI] | Recall@50 | Δ nDCG@10 vs bm25_only [95% CI] | beats BM25? | wall s |
|---|---|---:|---:|---:|---:|:---:|---:|
| bm25_only | hash / overlap | 0.505 [0.454, 0.555] | 0.730 [0.664, 0.793] | 0.843 | — | n/a | 0.1 |
| dense_only@bge-small | BAAI/bge-small-en-v1.5@5c38ec7 | 0.565 [0.509, 0.619] | 0.751 [0.692, 0.806] | 0.938 | +0.060 [+0.002, +0.118] | yes | 1.4 |
| hybrid@bge-small | BAAI/bge-small-en-v1.5@5c38ec7 | 0.696 [0.646, 0.745] | 0.820 [0.768, 0.872] | 0.938 | +0.190 [+0.144, +0.234] | yes | 2.1 |
| hybrid+bge-rerank@hash | BAAI/bge-reranker-v2-m3@953dc6f | 0.814 [0.768, 0.858] | 0.881 [0.835, 0.924] | 0.938 | +0.308 [+0.262, +0.354] | yes | 43.2 |
| hybrid+bge-rerank@bge-small | BAAI/bge-small-en-v1.5@5c38ec7, BAAI/bge-reranker-v2-m3@953dc6f | 0.812 [0.765, 0.856] | 0.879 [0.835, 0.921] | 0.938 | +0.307 [+0.259, +0.353] | yes | 45.8 |
| hybrid+bge-rerank+router+staleness@bge-small | BAAI/bge-small-en-v1.5@5c38ec7, BAAI/bge-reranker-v2-m3@953dc6f | 0.824 [0.781, 0.865] | 0.873 [0.829, 0.915] | 0.938 | +0.319 [+0.272, +0.364] | yes | 32.3 |
| dense_only@bge-base | BAAI/bge-base-en-v1.5@a5beb1e | 0.701 [0.647, 0.749] | 0.842 [0.791, 0.890] | 0.960 | +0.196 [+0.141, +0.249] | yes | 1.3 |
| hybrid@bge-base | BAAI/bge-base-en-v1.5@a5beb1e | 0.756 [0.704, 0.804] | 0.846 [0.801, 0.891] | 0.938 | +0.251 [+0.214, +0.290] | yes | 2.2 |

Hybrid RRF with bge-small vs BM25 alone: nDCG@10 +0.190 [+0.144, +0.234] (the interval excludes zero). Adding bge-reranker-v2-m3: +0.307 [+0.259, +0.353] vs BM25 (the interval excludes zero). Router + staleness on top of the reranked hybrid: +0.012 [-0.009, +0.033] (the interval covers zero).
<!-- bench-neural:end -->
...
<!-- bench-beir:start (generated by `make bench-table` from bench/results/main.json; do not edit by hand) -->
BEIR SciFact test split (`make bench-beir`): 5183 documents, 300 queries; cuda (Quadro RTX 8000), torch 2.5.1+cu121, sentence-transformers 6.1.0; results sha 29a3bef. Published BM25 nDCG@10 = 0.665 (Lucene English (Porter stemming + stopwords), k1=0.9, b=0.4).
...
|---|---|---:|---:|---:|---:|:---:|---:|
| bm25 | hash / overlap | 0.677 [0.630, 0.719] | 0.803 [0.757, 0.845] | 0.929 [0.899, 0.956] | — | n/a | 19.81 / 29.41 |
| bm25@default-tokenizer | hash / overlap | 0.601 [0.552, 0.649] | 0.718 [0.665, 0.766] | 0.821 [0.776, 0.862] | -0.076 [-0.104, -0.047] | no | 29.6 / 43.01 |
| dense@bge-small | BAAI/bge-small-en-v1.5@5c38ec7 | 0.720 [0.674, 0.761] | 0.845 [0.802, 0.885] | 0.953 [0.927, 0.973] | +0.043 [+0.011, +0.077] | yes | 16.39 / 48.04 |
| hybrid@bge-small | BAAI/bge-small-en-v1.5@5c38ec7 | 0.738 [0.694, 0.778] | 0.860 [0.820, 0.895] | 0.962 [0.937, 0.982] | +0.061 [+0.039, +0.083] | yes | 42.33 / 92.17 |
| hybrid+bge-rerank@bge-small | BAAI/bge-small-en-v1.5@5c38ec7, BAAI/bge-reranker-v2-m3@953dc6f | 0.752 [0.708, 0.792] | 0.865 [0.824, 0.902] | 0.962 [0.937, 0.982] | +0.075 [+0.053, +0.101] | yes | 959.28 / 1852.2 |

Our BM25 with the BEIR analyzer scores nDCG@10 0.677 against the published 0.665 (+0.012). Hybrid RRF vs BM25: nDCG@10 +0.061 [+0.039, +0.083] (the interval excludes zero). Hybrid + bge-reranker-v2-m3 vs BM25: nDCG@10 +0.075 [+0.053, +0.101] (the interval excludes zero).
<!-- bench-beir:end -->
...
not asserted. Router and staleness are fixture-specific mechanisms (exact paths,
versioned configs); their extra gain on top of the neural reranker is reported
with its interval and is not part of the SciFact rows. The reranker is scored
over the fused top 20 on SciFact to keep CPU time reasonable; `rerank_top` is in
each row's settings.
