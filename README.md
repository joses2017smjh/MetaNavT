...
|---|---:|---:|:---:|---|
| heuristic (heuristic token overlap, not an LLM) | 0.0 | 80 | no | 47 / 5 / 28 |
| qwen2.5:7b | 0.0 | 80 | no | 79 / 1 / 0 |
| llama3.1:8b | 0.0 | 80 | no | 79 / 1 / 0 |
| jury majority (qwen2.5:7b, llama3.1:8b) | 0.0 | 80 | no | — |
...
Verdict: no judge reached kappa >= 0.6 vs exact-match labels on simple_factual; judge scores stay off the README Mean judge scores are in the results file but are not printed here.
